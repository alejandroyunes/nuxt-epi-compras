<template>
  <svg width="80px" height="80px" viewBox="0 0 24 24" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <g transform="translate(0 -1028.4)">
      ...
      <g>
        ...
        <path d="m2 1032.4-0.5 1h3l0.5-1h-3zm5 0-0.25 1h3l0.25-1h-3zm5 0v1h2.25l-0.25-1h-2zm4 0 0.5 1h3l-0.5-1h-3z"
          fill="#c0392b" />
        <path d="m5 1032.4-0.5 1h3.0013l0.4987-1zm5 0-0.25 1h2.25v-1zm4 0 0.25 1h2.25l-0.5-1zm5 0 0.5 1h3l-0.5-1z"
          fill="#bdc3c7" />
      </g>
    </g>
  </svg>
